...
use node_template_runtime::{
	AccountId, BabeConfig, BalancesConfig, EVMConfig, EthereumConfig, GenesisConfig, GrandpaConfig, Signature, SudoConfig,
...
pub fn properties() -> Properties {
    ...
    properties.insert("tokenSymbol".into(), vec!["LUNES"].into());
    properties.insert("totalIssuance".into(), vec!["200_000_000"].into());
    properties.insert("tokenDecimals".into(), vec![8].into());
    properties
}
